...
const Collection = () => {
  ...
  return (
    <div className='flex relative flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
{/* filter options */}
<div className='  min-w-60'>
  <div className='sticky top-0'>

  
  <div className=' flex items-center gap-2' onClick={()=>setShoFilter(!showFilter)}>
...
<div className='flex-1'>
  <div className='flex justify-between text-base sm:text-2xl mb-4'>
    ...
    <select onChange={(e)=> setSortType(e.target.value)} className='border-2 border-gray-300 text-sm px-2'>
      ...
      <option value="high-low">Sort by: High T o Low</option>
    </select>
  </div>
